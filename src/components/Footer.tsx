...
export const Footer: React.FC = () => {
  return (
    ...
    {/* Spotlight effect */}
    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[900px] h-[900px] bg-[radial-gradient(circle_at_center,_rgba(63,21,152,0.6)_0%,_rgba(63,21,152,0.15)_40%,_transparent_70%)] opacity-90 blur-[120px] rounded-full pointer-events-none" />
    ...
    <div className="flex w-full max-w-[1217px] items-start gap-5 mt-[40px] flex-wrap justify-between ml-[31px] max-md:max-w-full relative z-10">
      <div className="w-[80px] h-[40px] md:w-[157px] md:h-[60px] rounded-lg flex items-center justify-center">
      ...
      <div className="flex items-stretch gap-[40px_100px] flex-wrap max-md:max-w-full">
        <nav className="flex flex-col text-base leading-loose pr-14">
          ...
          <a href="#contact" className="mt-2 text-gray-500 hover:text-white/80 transition-colors">FAQ</a>
        </nav>
        <nav className="flex flex-col text-base leading-loose">
